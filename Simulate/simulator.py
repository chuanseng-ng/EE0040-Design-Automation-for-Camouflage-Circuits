                ...
                if find_inv in logic_gate[b][0]:
                    for c in range(logic_gate_number):
                        if logic_gate[b][3] == logic_gate[c][2]:
                            if find_and in logic_gate[c][0]:
                                for d in range(input_number):
                                    if logic_gate[c][3] == input_list[0][d]:
                                        input1_value = input_list[1][d]
                                    elif logic_gate[c][4] == input_list[0][d]:
                                        input2_value = input_list[1][d]
                                    else:
                                        pass

                                for d in range(wire_number):
                                    if logic_gate[c][3] == wire_list[0][d]:
                                        input1_value = wire_list[1][d]
                                    elif logic_gate[c][4] == wire_list[0][d]:
                                        input2_value = wire_list[1][d]
                                    elif logic_gate[c][2] == wire_list[0][d]:
                                        output1_location = 1
                                        output1_position = d

                                for d in range(output_number):
                                    if logic_gate[c][3] == output_list[0][d]:
                                        input1_value = output_list[1][d]
                                    elif logic_gate[c][4] == output_list[0][d]:
                                        input2_value = output_list[1][d]
                                    else:
                                        pass
                                ...
                                if output1_location == 0:
                                    for f in range(output_number):
                                        if logic_gate[c][2] == output_list[0][f]:
                                            output1_location = 2
                                            output1_position = f
                                        else:
                                            pass
                                ...
                                if input1_value == 1 or input2_value == 1:
                                    output1_value = 1
                                else:
                                    output1_value = 0
                    ...
                    if find_and in logic_gate[b][0]:
                        for c in range(input_number):
                            if logic_gate[b][3] == input_list[0][c]:
                                input1_value = input_list[1][c]
                            elif logic_gate[b][4] == input_list[0][c]:
                                input2_value = input_list[1][c]
                            else:
                                pass
                        ...
                        for c in range(wire_number):
                            if logic_gate[b][3] == wire_list[0][c]:
                                input1_value = wire_list[1][c]
                            elif logic_gate[b][4] == wire_list[0][c]:
                                input2_value = wire_list[1][c]
                            elif logic_gate[b][2] == wire_list[0][c]:
                                output1_location = 1
                                output1_position = c
                        ...
                        for d in range(output_number):
                            if logic_gate[b][3] == output_list[0][d]:
                                input1_value = output_list[1][d]
                            elif logic_gate[b][4] == output_list[0][d]:
                                input2_value = output_list[1][d]
                            else:
                                pass
