...
import Camouflage.output_corrupt_research

def camouflage(simulator, camo_num):
    # Variable declaration
    #   List
    corrupt_list = Camouflage.output_corrupt_research.corrupt(simulator)
    ...
    while(True):
        ...
        for i in camouflage_count_list:
            modified_logic_gate[i][0] = Camouflage.output_corrupt_research.gate_change(modified_logic_gate[i][0])
