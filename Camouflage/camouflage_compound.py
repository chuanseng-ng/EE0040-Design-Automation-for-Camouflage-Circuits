...
def next_camouflage(modified_logic_gate, camouflage_count_list, original_result):
    corrupt_list = []
    modified_result = []
    ...
    for w in range(simulator.logic_gate_number):
        ...
        modified_logic_gate[w][0] = output_corrupt.gate_change(modified_logic_gate[w][0])
        ...
        corrupt_list.append(output_corrupt.output_corrupt(original_result, modified_result))
        print('\n', corrupt_list)
    ...
    modified_logic_gate[corrupt_list_count][0] = \
        output_corrupt.gate_change(modified_logic_gate[corrupt_list_count][0])
...
modified_logic_gate[first_camouflage_count][0] = \
    output_corrupt.gate_change(modified_logic_gate[first_camouflage_count][0])

while user_input != str(len(camouflage_count_list)):
    modified_logic_gate, camouflage_count_list = \
        next_camouflage(modified_logic_gate, camouflage_count_list, original_result)
